...
const REPORTS = [
  ...
  { key: "trial-balance", label: "Trial Balance", icon: "M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" },
  { key: "general-ledger", label: "General Ledger", icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" },
];
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          {REPORTS.map((r) => (
                            <Link
                              ...
                              className={`group inline-flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-medium transition-all ${
                                light
                                  ? "border border-gray-200 bg-white text-gray-600 hover:border-green-400 hover:text-green-700 hover:bg-green-50 hover:shadow-sm"
                                  : "border border-white/10 bg-white/[0.03] text-gray-400 hover:border-green-500/30 hover:text-green-400 hover:bg-green-500/5"
                              }`}
                            >
                              <svg className={`w-4 h-4 ${light ? "text-gray-400 group-hover:text-green-500" : "text-gray-500 group-hover:text-green-400"} transition-colors`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d={r.icon} /></svg>
                              {r.label}
                              <svg className={`w-3 h-3 ${light ? "text-gray-300 group-hover:text-green-400" : "text-gray-600 group-hover:text-green-400"} transition-colors`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                            </Link>
                          ))}
                          <button
