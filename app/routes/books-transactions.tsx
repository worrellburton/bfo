      ...
      <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            {/* The switch. Everything here is in px on purpose: the site scales
                rem down 15%, so a rem-sized track with a px-sized travel let
            ...
            >
              <span
                className={`absolute left-[2px] top-[2px] w-[16px] h-[16px] rounded-full bg-white shadow-sm transition-transform duration-200 ease-out ${
