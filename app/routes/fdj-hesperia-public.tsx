      ...
      <div className="space-y-6">
        {timelineEvents.map((evt, i) => (
          <div key={i} className="relative flex gap-4">
            <div
              className="absolute -left-6 top-1.5 w-[15px] h-[15px] rounded-full border-2 bg-[#0a0a0a] z-10"
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className="text-lg font-bold tracking-tight">BFO</span>
                <span className="text-[10px] text-gray-600">Burton Family Office</span>
              </div>
              <p className="text-[11px] text-gray-600">Generated by BFO - Burton Family Office</p>
            </div>
